...
%PR 2 St 3 Define basic radio interferometry concepts. Reference Thompson, Smirnov reference smirnov..iniyan's two papers 
...
Multiple effects then can be represented by multiplication of various Jones matricies.
\begin{equation*}
