...
This highlights the importance of synchontron self-absorption and the variable size of emission region, as size of observed $\tau \sim 1$ surface could also change depending on accretion history and the magnetic field configuration. As the $\tau \sim 1$ surface is frequency dependent, simultaneous multi-wavelength observations could lead to a more profitable EHT variability analysis.
