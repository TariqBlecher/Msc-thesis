...
We now attempt to isolate several separate but interlink modes of intrinsic variability. We focus on variability within an observation time as this represents the dominant challenge to calibration, imaging and/or parameter estimation. Following this, we outline the role of {\sc meqsilhouette} to assist with the analysis and interpretation. It has also been proposed by \citet{Lu_2016} that a Gaussian weighting scheme can be applied to mitigate the effects of variability and measure the quiescent structure although this approach would down-weight the longest baselines, losing information of the finer angular scales.
