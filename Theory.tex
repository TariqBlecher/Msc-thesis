...
%An intro following on from basics
...
\section{Troposphere}
%PR 2 St 2
%Introduction to the troposphere
...
\subsection{Wave propagation through a linear medium}
%propagation fundamentals (hmmm should this go before the scattering section?)
%PR 2 St 2
...
~\\
%repeat here, not sure which version is better
...
\subsection{Kolmogorov turbulence} 
%PR 1 St 2
