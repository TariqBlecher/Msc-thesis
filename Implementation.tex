...
%Implementation details of ATM st 3
...
%inputs
{\sc atm} calculates atmospheric temperature and pressure profiles using several station dependent inputs, namely, ground temperature and pressure and the PWV depth, water vapour scale height and altitude. Although changes in the altitude do not make much difference as  
%outputs


%phase turbulence st 3
%How it fits into the broader scheme
%what it does
Following from section~\ref{sec:turb_theory}, we simulate a equation~\ref{eq:turb_final}
