...
%The structure of the introduction is to be altered considerably to be made more succient and clear. At the moment, I'm looking at basing the structure on Ben's Intro. This would entail moving the meat of the VLBI and EHT sections to the theoretical background. I think I will get to EHT far quicker - maybe with 1 paragraph on high resolution science, 1 paragraph on VLBI, 1 paragraph introducing EHT... 



%TO BE CUT TO 1 paragraph-probably no figures..why go to high  resolution -> several examples (bh relations - HST, HL TAU-ALMA, bullet cluster - chandra??) of how an increase in resolution has lead to new physical insights. 
...
%to be cut to 1 paragraph, no heading
...
%Strong gravity and black hole spacetime
%Pr : 3, St: 3
...
~\\
%AGN accretion and jet launch astrophysics
