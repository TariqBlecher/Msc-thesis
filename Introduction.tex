...
%Accretion + jet launch intro + motivation  and relativistic jets as a common feature. st1
...
%M87
Compared to Sgr~A*, M87 is far more massive ($\sim 10^9 M_\odot$) and has a larger accretion rate ($\sim 10^{-4} L_{\rm edd}$). The location of the jet base in M87 in relation to its event horizon could help to constrain whether jet powered by the BH as opposed to the accretion disc.
%In contrast, the powerful jet in M87 is thought to be powered by an accretion disc in the Magnetically Arrested Disc \citep[(MAD),][]{Narayan_2003} state, wherein mass accretion to the BH is suppressed by the strong magnetic field build-up near the black hole.
